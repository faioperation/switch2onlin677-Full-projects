...
const ProductsPagination = ({ page, setPage, totalPages, total, limit, setLimit }) => {
    ...
    <div className="flex flex-col sm:flex-row justify-between items-center mt-6 gap-4">
      <div className="flex items-center gap-4 order-2 sm:order-1">
        <p className="text-xs text-gray-500">
          ...
          <span className="text-gray-300 font-medium">{total}</span> products
        </p>
        ...
        <div className="flex items-center gap-2 border-l border-[#262626] pl-4">
          ...
          <input
            ...
            className="w-12 bg-[#0B0B0B] border border-[#262626] rounded px-2 py-0.5 text-xs text-white outline-none focus:border-[#00CE51] transition-colors"
          />
        </div>
      </div>
